...
class WebRoutingTests(unittest.TestCase):
    ...
    def test_utilitaire_reste_une_application(self):
        with patch("core.plateforme.ouvrir") as lancer:
            resultat = systeme.ouvrir_application("calculatrice")

        self.assertEqual(resultat, "calculatrice lance.")
        self.assertEqual(lancer.call_args[0][0], plateforme.EST_MAC and "Calculator" or "calc")
